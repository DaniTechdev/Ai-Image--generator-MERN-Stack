...
const Header = () => {
  ...
  return (
    ...
    >
      <a
        href="/"
        className="hidden sm:flex cursor-pointer px-4 pl-6 left-0 h-full w-32"
      >
        <HeaderLogo />
      </a>
      ...
      >
        ...
        {navList.map((menu, index) => (
          <a
            className="flex flex-row items-center cursor-point
            h-full py-1.5 pb-0 px-2 justify-center transition-all flex-1"
            href={menu.link}
            style={{
              width: 80,
              zIndex: 2,
