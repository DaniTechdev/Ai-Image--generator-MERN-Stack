      ...
      {auth ? (
        <div className="sm:hidden absolute w-full flex items-center justify-end top-2 right-2">
          <button
            ...
            className="h-7 w-7 rounded-full text-xs md:text-sm bg-zinc-800 
            border border-zinc-700 drop-shadow flex items-center justify-center opacity-80 
            hover:opacity-100"
            type="button"
          >
            G
        ...
        <div className="sm:hidden absolute w-full flex items-center justify-end top-2 right-2">
          ...
          opacity-90 hover:brightness-100 px-4 text-xs md:text-sm bg-gradient-to-t
          from-indigo-800 via-indigo-800 to-indigo-600 drop-shadow font-medium whitespace-nowrap"
            type="button"
          >
            Get Started
          </a>
