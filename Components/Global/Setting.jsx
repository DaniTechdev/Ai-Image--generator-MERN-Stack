...
const Setting = ({ activeUser }) => {
  return (
    <div>
      <div
        className="w-64 bg-zinc-800 z-50 fixed right-0 top-5 rounded-md drop-shadow shadow
      text-sm  flex flex-col items-start overflow-hidden border
       border-zinc-700 sliderDownAndFade divide-y divide-zinc-700"
        style={{
          marginRight: "1rem",
          marginTop: "2rem",
        }}
